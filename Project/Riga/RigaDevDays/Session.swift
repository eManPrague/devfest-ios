...
class Session: DataObject {
    ...
    var sessionURL: String {
        get {
            ...
            return "https://2017.devfest.cz/schedule/day\(dayIndex+1)?sessionId=\(sessionIndex)"
        }
    }
    ...
    override init(snapshot: DataSnapshot) {
        ...
        if snapshotValue["track"] != nil {
            track = Track(snapshot: snapshot.childSnapshot(forPath: "track"))
        }
