...
extension Notification.Name {
    ...
    static let KMLUpdated = Notification.Name("rdd.kml.updated")
}
...
extension UIViewController {
    ...
    func displaySessionButton(_ visible: Bool) {
        let twitterButton = UIBarButtonItem(image: #imageLiteral(resourceName: "ic_twitter"), style: .plain, target: self, action: #selector(twitterButtonPressed))
        ...
        if visible {
            self.navigationItem.rightBarButtonItems = [sessionButton, twitterButton]
        } else {
    ...
    func twitterButtonPressed() {
        UIApplication.shared.openURL(URL(string: "https://twitter.com/hashtag/DevFestCZ")!)
    }
    
    func signInButtonPressed() {
        LoginManager.shared.presentLogin(fromVC: self)
    }
    ...
    func signOutButtonPressed() {
        ...
        do {
            ...
            Log.info("Error signing out: \(signOutError)")
        }
    }
}
...
class SwissKnife {
    ...
    func getEventDialogFor(_ session: Session, on day: Day, completion: @escaping (EKEventEditViewController?) -> Swift.Void, denied: @escaping (Void) -> Swift.Void) {
